...
{
    public class PrimaryVolumeDescriptor : BinarySerializable
    {
        ...
        public DirectoryRecord Root { get; set; }
        ...
        public override void SerializeImpl(SerializerObject s)
        {
            ...
            Root = s.SerializeObject<DirectoryRecord>(Root, name: nameof(Root));
